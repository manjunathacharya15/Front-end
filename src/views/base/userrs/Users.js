...
export default class CustomersList extends Component {
  ...
  componentDidMount() {
      ...
      axios.post('https://instructor9513.herokuapp.com/instructors/')
    .then(response => {
  ...
  const arrayids = [];
    ...
    axios.post('https://instructor9513.herokuapp.com/instructors/delete',{arrayids:arrayids})
    .then(response=>{
...
<div class="row">
  <div class="col-md">
    ...
    <div style={{width:"22%"}}><Link to="/welcome" className="nav-link"><button type="submit" value="AddNewTrainer" className="btn btn-success">AddTrainer+</button></Link></div>
